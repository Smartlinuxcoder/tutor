<script>
	...
	const downloadPdf = () => {
		...
		doc.setFontSize(12);
		doc.text("Scansiona il QR code per lasciare un feedback.", 105, 150, {
			align: "center",
		});
...
<div class="min-h-screen p-8">
	<div class="mx-auto max-w-4xl">
		<header
			class="glass-card mb-8 flex items-center justify-between rounded-md p-6"
		>
			<div>
				<h1
		...
		<!-- <div class="mb-8 flex justify-end">
			<a href="/registry" class="btn-primary rounded-md px-4 py-2">
		...
		<div class="grid gap-6 md:grid-cols-2">
			...
			<div class="glass-card rounded-md p-6">
				...
				<div class="flex flex-col items-center">
					...
					{:else}
						<div
							class="mb-4 flex h-32 w-32 items-center justify-center rounded-md"
						...
						>
							<div class="flex items-center justify-between">
								<div class="flex items-center">
									<span
										class="mr-2 text-lg font-bold text-yellow-500"
									>
